...
/* harmony default export */ var table_body = ({
  ...
  methods: {
    ...
    handleCellMouseEnter: function handleCellMouseEnter(event, row) {
      ...
      var cellChild = event.target.querySelector('.el-cell');
          ...
          return h(
            ...
            [columns.map(function (column, cellIndex) {
              return h(
                ...
                [h(
                  'div',
                  { 'class': ['el-cell dib bs vm w ell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] },
      ...
      [h('colgroup', [this.columns.map(function (column) {
        ...
        [h('tr', [this.columns.map(function (column, cellIndex) {
          return h(
            ...
            [h(
              'div',
              { 'class': ['el-cell', column.labelClassName] },
              [sums[cellIndex]]
            )]
          );
